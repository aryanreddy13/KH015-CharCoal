...
class PagerDutyService:
    ...
    def trigger_pagerduty_incident(
        ...
        automated_message = (
            f"SANJIVINI CRITICAL SOS. {disaster_type} emergency at {zone_name}. "
        ...
        payload = {
            ...
            "dedup_key": f"sanjivini-incident-{incident_id}",
            "payload": {
                "summary": f"🚨 SANJIVINI CRITICAL SOS — {zone_name} — {disaster_type}",
                "severity": "critical",
                "source": "Sanjivini Emergency Dispatch Coordinator",
