...
class EmailService:
    ...
    def send_emergency_email(
        ...
        <body>
          <div class="container">
            <span class="badge">PS20 CRITICAL EMERGENCY ALERT</span>
            ...
            <p style="color: #64748b; font-size: 12px; margin-top: 24px; border-top: 1px solid #1e293b; padding-top: 12px;">
              PS20 Disaster Relief & Emergency Resource Coordinator Automated Dispatch Pipeline.
            </p>
          </div>
        </body>
        </html>
        ...
        try:
            payload = {
                "from": settings.RESEND_FROM_EMAIL or "emergency-alerts@ps20-relief.gov",
                "to": [recipient],
                "subject": subject,
                "html": html_content,
            }
