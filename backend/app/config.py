...
class Settings(BaseSettings):
    PROJECT_NAME: str = "Sanjivini- Agentic Disaster Relief & Emergency Resource Coordinator"
    API_V1_STR: str = "/api"
    ...
    RESEND_FROM_EMAIL: str = os.getenv("RESEND_FROM_EMAIL", "emergency-alerts@sanjivini-relief.gov")
