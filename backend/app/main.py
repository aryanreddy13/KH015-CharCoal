...
logger = logging.getLogger("ps20_backend")

@asynccontextmanager
async def lifespan(app: FastAPI):
    # Startup: Create tables and auto-seed initial demo dataset
    logger.info("Initializing PS20 Disaster Database schema...")
    ...
    logger.info("PS20 Command Center Backend successfully started.")
    yield
    logger.info("PS20 Command Center Backend shutting down...")
